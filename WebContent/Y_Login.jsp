  ...
  <TR>
    <TD>
      <TABLE cellSpacing=0 cellPadding=0 width=623 align=center border=0>
        <TBODY>
        <TR>
          <TD align="center" colSpan=3 width="623" height="260" background="picture/welcome_01.gif">
          <!-- 验证码返回提示 -->
          <br><br><br><br><br>
...
<INPUT class=txt1 style="BACKGROUND-COLOR: #ffffff"  type=reset value=取消 name=ChkCngPwd> 
        ...
        <TR>
          <TD align="center" height=2 width="175" background="picture/welcome_05.gif"></TD></TR></TBODY></TABLE>
