...
<BODY bgColor=#ffffff leftMargin=0 background=/yuntong/picture/bj1.gif
      topMargin=0>
<DIV id=Layer1
                        ...
                        <TABLE cellSpacing=0 cellPadding=0 width=623 align=center border=0>
                                ...
                                <TD vAlign=left background="" height=13>
                                    <DIV align=left><FONT color=#006633 size=2>用户名：</FONT><FONT
                                            color=#006633 size=2> <INPUT value="" class=tx maxLength=15 size=15
                                                                         name=userName> </FONT><FONT color=#006633
                                                                                                     size=2>　</FONT>
                                    </DIV>
                                </TD>
                            ...
                            <TR>
                                <TD vAlign=left background="" height=9>
                                    <DIV align=left><FONT color=#006633 size=2>密&nbsp;&nbsp;&nbsp;码： <INPUT value=""
                                                                                                            class=tx
                                                                                                            type=password
                                                                                                            maxLength=15
                                                                                                            size=15
                            ...
                            <TR>
                                <TD vAlign=left background="" height=21>
                                    ...
                                    <FONT color=#006633 size=2>验证码： <INPUT class=tx
                                        ...
                                        　 </FONT><a href="#" onclick="doRequest();" style="text-decoration:none"><FONT
                                        color="#ff4080" size=2><span id="checkname"></span></FONT></a>


                                    <DIV align=center><FONT color=#006633 size=2>　　
                                        <input class=txt1 style="BACKGROUND-COLOR:#ffffff" type=submit value=确定
                                               name=ChkCngPwd2>　

                                        <INPUT class=txt1 style="BACKGROUND-COLOR: #ffffff" type=reset value=取消
                                               name=ChkCngPwd>
                                    </FONT></DIV>
                                </TD>
                            </TR>
